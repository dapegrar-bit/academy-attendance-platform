...
## تحديث الحضور الفجائي المتكرر

- يسمح النظام الآن بإرسال حضور فجائي للمتدرب حتى لو كان قد سجّل حضوره الأساسي للمحاضرة.
- كل إرسال حضور فجائي جديد من الإدارة يُعامل كطلب مستقل، ويظهر للمتدرب زر تحضير فجائي جديد.
- يتم حفظ سجلات الحضور الفجائي في جدول مستقل `InstantCheckinRecord` دون حذف أو تغيير سجلات الحضور الأساسية.
- عند النشر على Render يكفي تشغيل الأمر المعتاد: `python manage.py migrate --noinput` لإنشاء جدول الحضور الفجائي.
